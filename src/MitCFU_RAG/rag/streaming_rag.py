...
class StreamingRAG(RAG):
    def __init__(self, embedding_model, faiss_index, article_index, validator_model):
        ...
        """
        self.parser = None
        self.retriever = Mistrale5Retriever(embedding_model, faiss_index, article_index)
        self.reranker = None
    ...
    async def stream_response(self, messages: list[dict[str, Any]], version=None, *args, **kwargs) -> Generator[str, None, None]:
        """
        yields response tokens from rag request.
        """
